    ...
    <section className="py-24 md:py-32 bg-white border-b border-black/5 overflow-hidden">
      <div className="container mx-auto px-6 md:px-20 lg:px-24 grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-[#121212] rounded-3xl h-[400px] border border-black/5 flex flex-col items-center justify-center text-[11px] font-black uppercase tracking-widest shadow-[0_30px_60px_rgba(0,0,0,0.1)] p-12 text-center relative overflow-hidden"
        >
           ...
           <div className="relative z-10 text-white flex flex-col items-center gap-6">
              <span className="bg-red-500/20 text-red-500 border border-red-500/20 px-4 py-1.5 rounded-full text-[9px] font-bold tracking-widest uppercase">The Breakdown</span>
              ...
              <p className="font-medium tracking-wide opacity-50 text-[11px] normal-case max-w-[280px]">Automated filters, disjointed communication loops, and opaque delivery timelines result in massive margin loss for enterprise production teams.</p>
           </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm font-bold tracking-widest text-red-500/80 leading-relaxed uppercase">
