      ...
      <div className="container mx-auto px-6 md:px-20 grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
        ...
        <div className="flex flex-col gap-10 order-2 lg:order-1 border-l-[3px] border-black pl-8">
          ...
          <div className="flex flex-col">
            <div className="flex gap-6 py-6 border-b-2 border-black">
              <div className="w-8 h-8 rounded-sm bg-black border border-black flex items-center justify-center text-xs font-black text-white shrink-0">1</div>
            ...
            <div className="flex gap-6 py-6 border-b-2 border-black">
              <div className="w-8 h-8 rounded-sm bg-black border border-black flex items-center justify-center text-xs font-black text-white shrink-0">2</div>
              <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-6 py-6">
              <div className="w-8 h-8 rounded-sm bg-[#6366F1] border border-black flex items-center justify-center text-xs font-black text-white shrink-0 shadow-[2px_2px_0px_#121212]">3</div>
              <div className="flex flex-col gap-2">
        ...
        <div className="relative order-1 lg:order-2 lg:translate-x-4">
          <div className="relative bg-white border-2 border-black rounded-lg p-3 shadow-[8px_8px_0px_#6366F1] overflow-hidden aspect-[4/3] lg:h-[450px]">
            ...
            <div className="absolute bottom-6 left-6 right-6 p-4 bg-white/90 border-2 border-black rounded-md shadow-[4px_4px_0px_#121212]">
