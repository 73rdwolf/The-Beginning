      ...
      <div className="mx-auto grid min-h-[calc(100vh-88px)] max-w-[1600px] lg:grid-cols-[1.05fr_0.95fr]">
        <div className="flex flex-col justify-center px-8 py-16 sm:px-12 md:px-20 lg:py-20">
          <div className="mb-8 flex flex-wrap items-center gap-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-black bg-white px-4 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-black shadow-[4px_4px_0px_#121212]">
              <Sparkles className="h-3.5 w-3.5 text-[#6366F1]" strokeWidth={2.5} />
              Premium product editing from $0.19
            </div>
            <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.18em] text-black/60">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
            <Link
              ...
              className="inline-flex items-center justify-center gap-3 rounded-full border-2 border-black bg-black px-8 py-4 text-[11px] font-black uppercase tracking-[0.16em] text-white shadow-[6px_6px_0px_#6366F1] transition-all duration-200 hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[3px_3px_0px_#6366F1]"
            >
              Get 3 Free Edits
            ...
            <Link
              to="/services"
              className="inline-flex items-center gap-3 rounded-full border-2 border-black bg-white px-8 py-4 text-[11px] font-black uppercase tracking-[0.16em] text-black transition-all duration-200 hover:bg-black hover:text-white"
            >
              Explore Services
            </Link>
          </div>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {stats.map((stat) => (
              ...
              >
                ...
                <div className="mt-1 text-[10px] font-black uppercase tracking-[0.16em] text-black/52">
                  {stat.label}
                </div>
              </div>
            ))}
          ...
          <div className="mt-10 flex flex-col gap-3">
            {proofPoints.map((item) => (
              <div
                key={item}
                className="inline-flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.14em] text-black/72"
              >
          ...
          <div className="relative flex min-h-[640px] items-center px-6 py-12 sm:px-10 md:px-14 lg:h-full">
            <div className="relative mx-auto w-full max-w-[640px]">
              ...
              <div className="absolute -right-4 bottom-14 rounded-[24px] border border-[#6366F1] bg-[#6366F1] px-5 py-4 text-white shadow-[0_18px_50px_rgba(99,102,241,0.28)]">
                <div className="text-[10px] font-black uppercase tracking-[0.18em] text-white/72">
                  After Reframe
                </div>
              ...
              <div className="overflow-hidden rounded-[32px] border border-white/12 bg-[#111111] shadow-[0_32px_80px_rgba(0,0,0,0.45)]">
                <div className="flex items-center justify-between border-b border-white/10 px-6 py-4">
                  ...
                  <div className="rounded-full border border-white/12 bg-white/6 px-4 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-white/72">
                    18 / 42 approved
                  </div>
                </div>
                ...
                <div className="grid gap-3 p-5 md:grid-cols-[0.92fr_1.08fr]">
                  <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,_#2c2c2c_0%,_#1b1b1b_100%)] p-5">
                    <div className="mb-4 flex items-center justify-between">
                      <span className="rounded-full border border-white/10 bg-white/6 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-white/56">
                        Raw upload
                      </span>
                  ...
                  <div className="rounded-[24px] border border-[#6366F1]/40 bg-[linear-gradient(180deg,_rgba(99,102,241,0.22)_0%,_rgba(17,17,17,0.94)_30%,_#111111_100%)] p-5">
                    <div className="mb-4 flex items-center justify-between">
                      <span className="rounded-full border border-[#6366F1]/30 bg-[#6366F1]/16 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-[#c7c8ff]">
                        Delivered
                      </span>
                      <span className="text-[10px] font-black uppercase tracking-[0.18em] text-white/56">
                        After
                      </span>
                    </div>
                ...
                <div className="grid gap-3 border-t border-white/10 px-5 py-5 sm:grid-cols-3">
                  {['Background cleanup', 'Shadow rebuild', 'Color balancing'].map((item) => (
                    <div
                      key={item}
                      className="rounded-[20px] border border-white/10 bg-white/5 px-4 py-3 text-[10px] font-black uppercase tracking-[0.16em] text-white/72"
                    >
                      {item}
                    </div>
                  ))}
