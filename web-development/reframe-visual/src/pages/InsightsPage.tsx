        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1,2,3,4,5,6].map(i => (
             <div key={i} className="group cursor-pointer">
               ...
               <span className="text-[10px] font-bold tracking-widest text-[#6366F1] uppercase mb-2 block">Case Study</span>
               ...
               <p className="text-sm font-medium text-black/60">Exploring the architectural workflow shifts that save enterprise photo studios hundreds of editing hours.</p>
             </div>
          ))}
        </div>
      </main>
