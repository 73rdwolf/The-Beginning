        ...
        <div className="py-24 px-10 md:px-20 lg:px-[10%] xl:px-[12%]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
             <div className="bg-white border-2 border-black p-8 rounded-3xl shadow-[4px_4px_0px_#121212]">
                ...
                <p className="font-medium text-[15px] text-black/80">Every single curve, drop shadow, and stray hair is hand-pathed by humans. We strictly use automated technology for routing, QA validation, and tracking, not pixel manipulation.</p>
             </div>
             <div className="bg-white border-2 border-black p-8 rounded-3xl shadow-[4px_4px_0px_#121212]">
                <h3 className="font-outfit font-black text-2xl uppercase mb-4">Zero Compromises.</h3>
                <p className="font-medium text-[15px] text-black/80">E-commerce shouldn't mean 'low quality'. We deliver editorial-level frequency separation and vectorization at marketplace-level volumes.</p>
             </div>
             <div className="bg-white border-2 border-black p-8 rounded-3xl shadow-[4px_4px_0px_#121212]">
                <h3 className="font-outfit font-black text-2xl uppercase mb-4">Guaranteed QC.</h3>
                <p className="font-medium text-[15px] text-black/80">Our 4-Agent proprietary framework scans the uploaded assets structurally. We offer a 100% refund guarantee if it fails to hit original complexity marks upon review.</p>
             </div>
          </div>
        </div>
      </main>
