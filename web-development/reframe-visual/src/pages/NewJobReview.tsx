    ...
    <div className="min-h-screen bg-[#F9F9F9] flex flex-col font-inter">
      ...
      <main className="flex-grow py-12 px-10 md:px-20 lg:px-[10%] xl:px-[12%] pb-32">
        ...
        <div className="max-w-4xl bg-white border-2 border-black p-8 rounded-3xl shadow-[6px_6px_0px_#121212]">
          ...
          <div className="flex justify-between items-end mb-4 border-b border-black/10 pb-4">
            <div>
              ...
              <p className="text-[15px] font-medium text-black/60">Medium Complexity (24h Turnaround)</p>
            </div>
            <div className="text-right">
              <span className="block text-[15px] font-medium">42 Images x $0.49</span>
          ...
          <div className="bg-[#121212] text-white p-6 flex justify-between items-center mt-8">
            <span className="font-bold tracking-widest uppercase text-[13.5px]">Total Estimated Price</span>
            <span className="font-black font-outfit text-3xl">$16.46</span>
          </div>
          
          <p className="text-[12px] uppercase font-bold tracking-widest text-black/50 text-center mt-6">
        ...
        <div className="fixed bottom-0 left-0 w-full bg-[#121212] border-t-4 border-[#6366F1] py-4 px-10 md:px-20 lg:px-[10%] flex justify-end items-center z-50">
          <a href="/dashboard" className="bg-[#6366F1] text-white px-8 py-4 rounded-full text-[13.5px] font-bold tracking-widest uppercase hover:bg-white hover:text-black transition-colors">Submit Job — Pay After Review</a>
        </div>
      </main>
    </div>
  );
