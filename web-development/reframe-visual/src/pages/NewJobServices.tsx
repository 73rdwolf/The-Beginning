    ...
    <div className="min-h-screen bg-[#F9F9F9] flex flex-col font-inter">
      ...
      <main className="flex-grow py-12 px-10 md:px-20 lg:px-[10%] xl:px-[12%]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          <div className="bg-white border-2 border-[#6366F1] p-6 shadow-[4px_4px_0px_#6366F1]">
          ...
          <div className="bg-white border-2 border-black/20 p-6 hover:border-black cursor-pointer transition-colors">
        ...
        <div className="fixed bottom-0 left-0 w-full bg-[#121212] border-t-4 border-[#6366F1] py-4 px-10 md:px-20 lg:px-[10%] flex justify-between items-center z-50">
          ...
          <a href="/jobs/new/upload" className="bg-[#6366F1] text-white px-8 py-4 text-[11px] font-bold tracking-widest uppercase hover:bg-white hover:text-black transition-colors">Continue to Upload —</a>
        </div>
      </main>
    </div>
  );
