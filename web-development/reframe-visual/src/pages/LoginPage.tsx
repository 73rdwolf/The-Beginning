  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] flex flex-col font-inter">
      ...
      <main className="flex-grow flex items-center justify-center py-24 px-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-md bg-white border border-black/5 rounded-3xl p-10 md:p-14 shadow-[0_30px_60px_rgb(0,0,0,0.08)] relative z-10">
          ...
          <form className="flex flex-col gap-5">
            <div>
              ...
              <input type="email" placeholder="agency@example.com" className="w-full p-4 border border-black/5 rounded-3xl/20 focus:border-[#6366F1] outline-none font-medium transition-colors" />
            </div>
            <div>
              ...
              <input type="password" placeholder="••••••••" className="w-full p-4 border border-black/5 rounded-3xl/20 focus:border-[#6366F1] outline-none font-medium transition-colors" />
            </div>
            
            <button type="button" onClick={() => window.location.href='/dashboard'} className="w-full bg-black text-white py-4 mt-4 uppercase text-[11px] font-bold tracking-wider border border-black/5 rounded-3xl hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] transition-all">
              Sign In —
            </button>
          </form>
          ...
          <button className="w-full bg-white text-black py-4 uppercase text-[11px] font-bold tracking-wider border border-black/5 rounded-3xl/20 hover:border-black transition-colors flex justify-center items-center gap-2">
            Google
          </button>
        </div>
      </main>
