    ...
    <div className="min-h-screen bg-[#F9F9F9] flex flex-col font-inter">
      ...
      <main className="flex-grow py-12 px-10 md:px-20 lg:px-[10%] xl:px-[12%]">
        <div className="flex justify-between items-end mb-8 border-b-2 border-black pb-6">
          ...
          <a href="/jobs/9482/review" className="bg-[#6366F1] text-white px-6 py-3 text-[10px] font-bold tracking-widest uppercase hover:-translate-y-1 border-2 border-black shadow-[4px_4px_0px_#121212] transition-all">
            Review Ready Images
          </a>
        </div>
